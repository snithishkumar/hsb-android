...
public interface MenuItemsDao {
    ...
    List<MenuEntity> getMenuEntityList(MenuCourseEntity menuCourseEntity)throws SQLException;
    ...
    boolean getAvailableMenuEntity(MenuCourseEntity menuCourseEntity)throws SQLException;
}
