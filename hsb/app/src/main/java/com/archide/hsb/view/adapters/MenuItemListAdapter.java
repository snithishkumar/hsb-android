...
import static hsb.archide.com.hsb.R.id.info_view;
...
public class MenuItemListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MenuItemListAdapter(List<MenuItemsViewModel> menuItemsViewModels, MenuItemsFragment menuItemsFragment, HomeActivity homeActivity, OrderDetailsViewModel orderDetailsViewModel,Context context) {
    ...
    public class MenuItemsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MenuItemsViewHolder(View view) {
            ...
            infoView = (ImageButton) view.findViewById(info_view);
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case info_view:
                    ...
                    builder.setTitle(menuItemsViewModel.getName())
                            .setMessage(menuItemsViewModel.getDescription())
